<template>
  <div>
      <div class="card">
        <div class="title">
          <div class="bj-left">
            <img :src="list.avatar == null ? serverUrl + '/moodland/vue'+'/img/avatar.svg' : serverUrl + '/moodland/' + list.avatar" alt="portrait">
          </div>
          <div class="bj-right">
        ...
        <div class="container">
          <img :src="list.picture == null ? serverUrl + '/moodland/vue'+'/img/avatar.svg' : serverUrl + '/moodland/' + list.picture"
            alt="mood image" />
          <div class="content">
            <div class = "info">
              ...
              <div class="portrait">
                <img v-for="(list, index) in friendlikes" :key="index"
                  :src="list.avatar == null ? serverUrl + '/moodland/vue'+'/img/avatar.svg' : serverUrl + '/moodland/' + list.avatar"
                  alt="用户avatar">
              </div>
            </div>
