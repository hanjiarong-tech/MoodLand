					...
					return createClass$1(Tooltip, [{
						...
						value: function(reference, template) {
							...
							return tooltipNode.id = "tooltip_" + Math.random()
								.toString(36)
								.substr(2, 10), tooltipNode.setAttribute("aria-hidden", "true"), this.options.autoHide && -1 !== this.options.trigger.indexOf("hover") && (tooltipNode.addEventListener("mouseenter", this.hide), tooltipNode.addEventListener("click", this.hide)), tooltipNode
						}
					}, {
						key: "_setContent",
